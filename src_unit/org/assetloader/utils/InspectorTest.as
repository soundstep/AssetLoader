package org.assetloader.utils {
	...
	public class InspectorTest
	{
		...
		public function runBeforeEachTest() : void
		{
			...
			_loader.addEventListener(AssetLoaderEvent.COMPLETE, Async.asyncHandler(this, loader_onComplete_handler, 500));
			_loader.start();
		}

		protected function loader_onComplete_handler(event : AssetLoaderEvent, data : Object) : void
		{
			data;
